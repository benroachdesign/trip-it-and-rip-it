...
extension Member {
    static let allMockMembers: [Member] = [
        ...
        Member(id: UUID(), fullName: "Ryan Strub",      nickname: "Strub",  sortOrder: 20,  isGuest: false, isOg: true,  homeCity: "Madison",       handicap: 12, funFact: nil, bio: nil),
        ...
        Member(id: UUID(), fullName: "Derek DeCarolis", nickname: "Derek",  sortOrder: 80,  isGuest: false, isOg: false, homeCity: "Minneapolis",   handicap: 13, funFact: nil, bio: nil),
